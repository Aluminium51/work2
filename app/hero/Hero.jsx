  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href="#projects"
          className="mt-6 px-6 py-3 font-bold bg-light-blue-500 text-white rounded-lg hover:bg-light-blue-600 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500"
        >
          View My Project
        </a>
      </div>
